...
// Simulation code
 ...
 if  (((state->self_clk_last) == 0) && ((state->self_clk) == 1)) {
   ...
   (state->lb_padded_2_stencil_update_stream$reg_2_2) = ((true) ? (state->lb_padded_2_stencil_update_stream$reg_2_1) : (state->lb_padded_2_stencil_update_stream$reg_2_2));
   (state->lb_padded_2_stencil_update_stream$reg_2_1) = ((true) ? lb_padded_2_stencil_update_stream$mem_2$mem_rdata : (state->lb_padded_2_stencil_update_stream$reg_2_1));
   (state->lb_padded_2_stencil_update_stream$reg_1_2) = ((true) ? (state->lb_padded_2_stencil_update_stream$reg_1_1) : (state->lb_padded_2_stencil_update_stream$reg_1_2));
   (state->lb_padded_2_stencil_update_stream$reg_1_1) = ((true) ? lb_padded_2_stencil_update_stream$mem_1$mem_rdata : (state->lb_padded_2_stencil_update_stream$reg_1_1));
   (state->lb_padded_2_stencil_update_stream$reg_0_2) = ((true) ? (state->lb_padded_2_stencil_update_stream$reg_0_1) : (state->lb_padded_2_stencil_update_stream$reg_0_2));
   (state->lb_padded_2_stencil_update_stream$mem_2$waddr$reg0) = ((true) ? (/* LOCAL */lb_padded_2_stencil_update_stream_wen_out ? (MASK( 1, (/* LOCAL */lb_padded_2_stencil_update_stream$mem_2$add_w_out == /* LOCAL */lb_padded_2_stencil_update_stream$mem_2$max_const_out) ) ? /* LOCAL */lb_padded_2_stencil_update_stream$mem_2$zero_const_out : /* LOCAL */lb_padded_2_stencil_update_stream$mem_2$add_w_out) : (state->lb_padded_2_stencil_update_stream$mem_2$waddr$reg0)) : (state->lb_padded_2_stencil_update_stream$mem_2$waddr$reg0));
   (state->lb_padded_2_stencil_update_stream$mem_2$raddr$reg0) = ((true) ? (/* LOCAL */lb_padded_2_stencil_update_stream_wen_out ? (MASK( 1, (/* LOCAL */lb_padded_2_stencil_update_stream$mem_2$add_r_out == /* LOCAL */lb_padded_2_stencil_update_stream$mem_2$max_const_out) ) ? /* LOCAL */lb_padded_2_stencil_update_stream$mem_2$zero_const_out : /* LOCAL */lb_padded_2_stencil_update_stream$mem_2$add_r_out) : (state->lb_padded_2_stencil_update_stream$mem_2$raddr$reg0)) : (state->lb_padded_2_stencil_update_stream$mem_2$raddr$reg0));
   ...
   (state->lb_padded_2_stencil_update_stream$mem_1$waddr$reg0) = ((true) ? (/* LOCAL */lb_padded_2_stencil_update_stream_wen_out ? (MASK( 1, (/* LOCAL */lb_padded_2_stencil_update_stream$mem_1$add_w_out == /* LOCAL */lb_padded_2_stencil_update_stream$mem_1$max_const_out) ) ? /* LOCAL */lb_padded_2_stencil_update_stream$mem_1$zero_const_out : /* LOCAL */lb_padded_2_stencil_update_stream$mem_1$add_w_out) : (state->lb_padded_2_stencil_update_stream$mem_1$waddr$reg0)) : (state->lb_padded_2_stencil_update_stream$mem_1$waddr$reg0));
   (state->lb_padded_2_stencil_update_stream$mem_1$raddr$reg0) = ((true) ? (/* LOCAL */lb_padded_2_stencil_update_stream_wen_out ? (MASK( 1, (/* LOCAL */lb_padded_2_stencil_update_stream$mem_1$add_r_out == /* LOCAL */lb_padded_2_stencil_update_stream$mem_1$max_const_out) ) ? /* LOCAL */lb_padded_2_stencil_update_stream$mem_1$zero_const_out : /* LOCAL */lb_padded_2_stencil_update_stream$mem_1$add_r_out) : (state->lb_padded_2_stencil_update_stream$mem_1$raddr$reg0)) : (state->lb_padded_2_stencil_update_stream$mem_1$raddr$reg0));
   (state->lb_p3_cim_stencil_update_stream$reg_2_2) = ((true) ? (state->lb_p3_cim_stencil_update_stream$reg_2_1) : (state->lb_p3_cim_stencil_update_stream$reg_2_2));
   (state->lb_p3_cim_stencil_update_stream$reg_2_1) = ((true) ? lb_p3_cim_stencil_update_stream$mem_2$mem_rdata : (state->lb_p3_cim_stencil_update_stream$reg_2_1));
   (state->lb_p3_cim_stencil_update_stream$reg_1_2) = ((true) ? (state->lb_p3_cim_stencil_update_stream$reg_1_1) : (state->lb_p3_cim_stencil_update_stream$reg_1_2));
   (state->lb_p3_cim_stencil_update_stream$reg_1_1) = ((true) ? lb_p3_cim_stencil_update_stream$mem_1$mem_rdata : (state->lb_p3_cim_stencil_update_stream$reg_1_1));
   (state->lb_p3_cim_stencil_update_stream$reg_0_2) = ((true) ? (state->lb_p3_cim_stencil_update_stream$reg_0_1) : (state->lb_p3_cim_stencil_update_stream$reg_0_2));
   (state->lb_p3_cim_stencil_update_stream$mem_2$waddr$reg0) = ((true) ? (/* LOCAL */lb_p3_cim_stencil_update_stream_wen_out ? (MASK( 1, (/* LOCAL */lb_p3_cim_stencil_update_stream$mem_2$add_w_out == /* LOCAL */lb_p3_cim_stencil_update_stream$mem_2$max_const_out) ) ? /* LOCAL */lb_p3_cim_stencil_update_stream$mem_2$zero_const_out : /* LOCAL */lb_p3_cim_stencil_update_stream$mem_2$add_w_out) : (state->lb_p3_cim_stencil_update_stream$mem_2$waddr$reg0)) : (state->lb_p3_cim_stencil_update_stream$mem_2$waddr$reg0));
   (state->lb_p3_cim_stencil_update_stream$mem_2$raddr$reg0) = ((true) ? (/* LOCAL */lb_p3_cim_stencil_update_stream_wen_out ? (MASK( 1, (/* LOCAL */lb_p3_cim_stencil_update_stream$mem_2$add_r_out == /* LOCAL */lb_p3_cim_stencil_update_stream$mem_2$max_const_out) ) ? /* LOCAL */lb_p3_cim_stencil_update_stream$mem_2$zero_const_out : /* LOCAL */lb_p3_cim_stencil_update_stream$mem_2$add_r_out) : (state->lb_p3_cim_stencil_update_stream$mem_2$raddr$reg0)) : (state->lb_p3_cim_stencil_update_stream$mem_2$raddr$reg0));
   (state->lb_p3_cim_stencil_update_stream$mem_2$mem)[ (state->lb_p3_cim_stencil_update_stream$mem_2$waddr$reg0) ] = ((true && /* LOCAL */lb_p3_cim_stencil_update_stream_wen_out) ? lb_p3_cim_stencil_update_stream$mem_1$mem_rdata : (state->lb_p3_cim_stencil_update_stream$mem_2$mem)[ (state->lb_p3_cim_stencil_update_stream$mem_2$waddr$reg0) ]);
   (state->lb_p3_cim_stencil_update_stream$mem_1$waddr$reg0) = ((true) ? (/* LOCAL */lb_p3_cim_stencil_update_stream_wen_out ? (MASK( 1, (/* LOCAL */lb_p3_cim_stencil_update_stream$mem_1$add_w_out == /* LOCAL */lb_p3_cim_stencil_update_stream$mem_1$max_const_out) ) ? /* LOCAL */lb_p3_cim_stencil_update_stream$mem_1$zero_const_out : /* LOCAL */lb_p3_cim_stencil_update_stream$mem_1$add_w_out) : (state->lb_p3_cim_stencil_update_stream$mem_1$waddr$reg0)) : (state->lb_p3_cim_stencil_update_stream$mem_1$waddr$reg0));
   (state->lb_p3_cim_stencil_update_stream$mem_1$raddr$reg0) = ((true) ? (/* LOCAL */lb_p3_cim_stencil_update_stream_wen_out ? (MASK( 1, (/* LOCAL */lb_p3_cim_stencil_update_stream$mem_1$add_r_out == /* LOCAL */lb_p3_cim_stencil_update_stream$mem_1$max_const_out) ) ? /* LOCAL */lb_p3_cim_stencil_update_stream$mem_1$zero_const_out : /* LOCAL */lb_p3_cim_stencil_update_stream$mem_1$add_r_out) : (state->lb_p3_cim_stencil_update_stream$mem_1$raddr$reg0)) : (state->lb_p3_cim_stencil_update_stream$mem_1$raddr$reg0));
   (state->lb_grad_yy_2_stencil_update_stream$mem_2$waddr$reg0) = ((true) ? (/* LOCAL */lb_grad_yy_2_stencil_update_stream_wen_out ? (MASK( 1, (/* LOCAL */lb_grad_yy_2_stencil_update_stream$mem_2$add_w_out == /* LOCAL */lb_grad_yy_2_stencil_update_stream$mem_2$max_const_out) ) ? /* LOCAL */lb_grad_yy_2_stencil_update_stream$mem_2$zero_const_out : /* LOCAL */lb_grad_yy_2_stencil_update_stream$mem_2$add_w_out) : (state->lb_grad_yy_2_stencil_update_stream$mem_2$waddr$reg0)) : (state->lb_grad_yy_2_stencil_update_stream$mem_2$waddr$reg0));
   (state->lb_grad_yy_2_stencil_update_stream$mem_2$raddr$reg0) = ((true) ? (/* LOCAL */lb_grad_yy_2_stencil_update_stream_wen_out ? (MASK( 1, (/* LOCAL */lb_grad_yy_2_stencil_update_stream$mem_2$add_r_out == /* LOCAL */lb_grad_yy_2_stencil_update_stream$mem_2$max_const_out) ) ? /* LOCAL */lb_grad_yy_2_stencil_update_stream$mem_2$zero_const_out : /* LOCAL */lb_grad_yy_2_stencil_update_stream$mem_2$add_r_out) : (state->lb_grad_yy_2_stencil_update_stream$mem_2$raddr$reg0)) : (state->lb_grad_yy_2_stencil_update_stream$mem_2$raddr$reg0));
   (state->lb_grad_yy_2_stencil_update_stream$mem_2$mem)[ (state->lb_grad_yy_2_stencil_update_stream$mem_2$waddr$reg0) ] = ((true && /* LOCAL */lb_grad_yy_2_stencil_update_stream_wen_out) ? lb_grad_yy_2_stencil_update_stream$mem_1$mem_rdata : (state->lb_grad_yy_2_stencil_update_stream$mem_2$mem)[ (state->lb_grad_yy_2_stencil_update_stream$mem_2$waddr$reg0) ]);
   (state->lb_grad_yy_2_stencil_update_stream$mem_1$waddr$reg0) = ((true) ? (/* LOCAL */lb_grad_yy_2_stencil_update_stream_wen_out ? (MASK( 1, (/* LOCAL */lb_grad_yy_2_stencil_update_stream$mem_1$add_w_out == /* LOCAL */lb_grad_yy_2_stencil_update_stream$mem_1$max_const_out) ) ? /* LOCAL */lb_grad_yy_2_stencil_update_stream$mem_1$zero_const_out : /* LOCAL */lb_grad_yy_2_stencil_update_stream$mem_1$add_w_out) : (state->lb_grad_yy_2_stencil_update_stream$mem_1$waddr$reg0)) : (state->lb_grad_yy_2_stencil_update_stream$mem_1$waddr$reg0));
   (state->lb_grad_yy_2_stencil_update_stream$mem_1$raddr$reg0) = ((true) ? (/* LOCAL */lb_grad_yy_2_stencil_update_stream_wen_out ? (MASK( 1, (/* LOCAL */lb_grad_yy_2_stencil_update_stream$mem_1$add_r_out == /* LOCAL */lb_grad_yy_2_stencil_update_stream$mem_1$max_const_out) ) ? /* LOCAL */lb_grad_yy_2_stencil_update_stream$mem_1$zero_const_out : /* LOCAL */lb_grad_yy_2_stencil_update_stream$mem_1$add_r_out) : (state->lb_grad_yy_2_stencil_update_stream$mem_1$raddr$reg0)) : (state->lb_grad_yy_2_stencil_update_stream$mem_1$raddr$reg0));
   (state->lb_grad_xy_2_stencil_update_stream$mem_2$waddr$reg0) = ((true) ? (/* LOCAL */lb_grad_xy_2_stencil_update_stream_wen_out ? (MASK( 1, (/* LOCAL */lb_grad_xy_2_stencil_update_stream$mem_2$add_w_out == /* LOCAL */lb_grad_xy_2_stencil_update_stream$mem_2$max_const_out) ) ? /* LOCAL */lb_grad_xy_2_stencil_update_stream$mem_2$zero_const_out : /* LOCAL */lb_grad_xy_2_stencil_update_stream$mem_2$add_w_out) : (state->lb_grad_xy_2_stencil_update_stream$mem_2$waddr$reg0)) : (state->lb_grad_xy_2_stencil_update_stream$mem_2$waddr$reg0));
   (state->lb_grad_xy_2_stencil_update_stream$mem_2$raddr$reg0) = ((true) ? (/* LOCAL */lb_grad_xy_2_stencil_update_stream_wen_out ? (MASK( 1, (/* LOCAL */lb_grad_xy_2_stencil_update_stream$mem_2$add_r_out == /* LOCAL */lb_grad_xy_2_stencil_update_stream$mem_2$max_const_out) ) ? /* LOCAL */lb_grad_xy_2_stencil_update_stream$mem_2$zero_const_out : /* LOCAL */lb_grad_xy_2_stencil_update_stream$mem_2$add_r_out) : (state->lb_grad_xy_2_stencil_update_stream$mem_2$raddr$reg0)) : (state->lb_grad_xy_2_stencil_update_stream$mem_2$raddr$reg0));
   (state->lb_grad_xy_2_stencil_update_stream$mem_2$mem)[ (state->lb_grad_xy_2_stencil_update_stream$mem_2$waddr$reg0) ] = ((true && /* LOCAL */lb_grad_xy_2_stencil_update_stream_wen_out) ? lb_grad_xy_2_stencil_update_stream$mem_1$mem_rdata : (state->lb_grad_xy_2_stencil_update_stream$mem_2$mem)[ (state->lb_grad_xy_2_stencil_update_stream$mem_2$waddr$reg0) ]);
   (state->lb_grad_xy_2_stencil_update_stream$mem_1$waddr$reg0) = ((true) ? (/* LOCAL */lb_grad_xy_2_stencil_update_stream_wen_out ? (MASK( 1, (/* LOCAL */lb_grad_xy_2_stencil_update_stream$mem_1$add_w_out == /* LOCAL */lb_grad_xy_2_stencil_update_stream$mem_1$max_const_out) ) ? /* LOCAL */lb_grad_xy_2_stencil_update_stream$mem_1$zero_const_out : /* LOCAL */lb_grad_xy_2_stencil_update_stream$mem_1$add_w_out) : (state->lb_grad_xy_2_stencil_update_stream$mem_1$waddr$reg0)) : (state->lb_grad_xy_2_stencil_update_stream$mem_1$waddr$reg0));
   (state->lb_grad_xy_2_stencil_update_stream$mem_1$raddr$reg0) = ((true) ? (/* LOCAL */lb_grad_xy_2_stencil_update_stream_wen_out ? (MASK( 1, (/* LOCAL */lb_grad_xy_2_stencil_update_stream$mem_1$add_r_out == /* LOCAL */lb_grad_xy_2_stencil_update_stream$mem_1$max_const_out) ) ? /* LOCAL */lb_grad_xy_2_stencil_update_stream$mem_1$zero_const_out : /* LOCAL */lb_grad_xy_2_stencil_update_stream$mem_1$add_r_out) : (state->lb_grad_xy_2_stencil_update_stream$mem_1$raddr$reg0)) : (state->lb_grad_xy_2_stencil_update_stream$mem_1$raddr$reg0));
   (state->lb_grad_xx_2_stencil_update_stream$mem_2$waddr$reg0) = ((true) ? (/* LOCAL */lb_grad_xx_2_stencil_update_stream_wen_out ? (MASK( 1, (/* LOCAL */lb_grad_xx_2_stencil_update_stream$mem_2$add_w_out == /* LOCAL */lb_grad_xx_2_stencil_update_stream$mem_2$max_const_out) ) ? /* LOCAL */lb_grad_xx_2_stencil_update_stream$mem_2$zero_const_out : /* LOCAL */lb_grad_xx_2_stencil_update_stream$mem_2$add_w_out) : (state->lb_grad_xx_2_stencil_update_stream$mem_2$waddr$reg0)) : (state->lb_grad_xx_2_stencil_update_stream$mem_2$waddr$reg0));
   (state->lb_grad_xx_2_stencil_update_stream$mem_2$raddr$reg0) = ((true) ? (/* LOCAL */lb_grad_xx_2_stencil_update_stream_wen_out ? (MASK( 1, (/* LOCAL */lb_grad_xx_2_stencil_update_stream$mem_2$add_r_out == /* LOCAL */lb_grad_xx_2_stencil_update_stream$mem_2$max_const_out) ) ? /* LOCAL */lb_grad_xx_2_stencil_update_stream$mem_2$zero_const_out : /* LOCAL */lb_grad_xx_2_stencil_update_stream$mem_2$add_r_out) : (state->lb_grad_xx_2_stencil_update_stream$mem_2$raddr$reg0)) : (state->lb_grad_xx_2_stencil_update_stream$mem_2$raddr$reg0));
   (state->lb_grad_xx_2_stencil_update_stream$mem_1$waddr$reg0) = ((true) ? (/* LOCAL */lb_grad_xx_2_stencil_update_stream_wen_out ? (MASK( 1, (/* LOCAL */lb_grad_xx_2_stencil_update_stream$mem_1$add_w_out == /* LOCAL */lb_grad_xx_2_stencil_update_stream$mem_1$max_const_out) ) ? /* LOCAL */lb_grad_xx_2_stencil_update_stream$mem_1$zero_const_out : /* LOCAL */lb_grad_xx_2_stencil_update_stream$mem_1$add_w_out) : (state->lb_grad_xx_2_stencil_update_stream$mem_1$waddr$reg0)) : (state->lb_grad_xx_2_stencil_update_stream$mem_1$waddr$reg0));
   (state->lb_grad_xx_2_stencil_update_stream$mem_2$mem)[ (state->lb_grad_xx_2_stencil_update_stream$mem_2$waddr$reg0) ] = ((true && /* LOCAL */lb_grad_xx_2_stencil_update_stream_wen_out) ? lb_grad_xx_2_stencil_update_stream$mem_1$mem_rdata : (state->lb_grad_xx_2_stencil_update_stream$mem_2$mem)[ (state->lb_grad_xx_2_stencil_update_stream$mem_2$waddr$reg0) ]);
   (state->lb_grad_xx_2_stencil_update_stream$mem_1$raddr$reg0) = ((true) ? (/* LOCAL */lb_grad_xx_2_stencil_update_stream_wen_out ? (MASK( 1, (/* LOCAL */lb_grad_xx_2_stencil_update_stream$mem_1$add_r_out == /* LOCAL */lb_grad_xx_2_stencil_update_stream$mem_1$max_const_out) ) ? /* LOCAL */lb_grad_xx_2_stencil_update_stream$mem_1$zero_const_out : /* LOCAL */lb_grad_xx_2_stencil_update_stream$mem_1$add_r_out) : (state->lb_grad_xx_2_stencil_update_stream$mem_1$raddr$reg0)) : (state->lb_grad_xx_2_stencil_update_stream$mem_1$raddr$reg0));
   (state->lb_grad_yy_2_stencil_update_stream$reg_0_2) = ((true) ? (state->lb_grad_yy_2_stencil_update_stream$reg_0_1) : (state->lb_grad_yy_2_stencil_update_stream$reg_0_2));
   (state->lb_grad_yy_2_stencil_update_stream$reg_1_1) = ((true) ? lb_grad_yy_2_stencil_update_stream$mem_1$mem_rdata : (state->lb_grad_yy_2_stencil_update_stream$reg_1_1));
   (state->lb_grad_yy_2_stencil_update_stream$reg_1_2) = ((true) ? (state->lb_grad_yy_2_stencil_update_stream$reg_1_1) : (state->lb_grad_yy_2_stencil_update_stream$reg_1_2));
   (state->lb_grad_yy_2_stencil_update_stream$reg_2_2) = ((true) ? (state->lb_grad_yy_2_stencil_update_stream$reg_2_1) : (state->lb_grad_yy_2_stencil_update_stream$reg_2_2));
   (state->lb_grad_yy_2_stencil_update_stream$reg_2_1) = ((true) ? lb_grad_yy_2_stencil_update_stream$mem_2$mem_rdata : (state->lb_grad_yy_2_stencil_update_stream$reg_2_1));
   (state->lb_grad_xy_2_stencil_update_stream$reg_0_2) = ((true) ? (state->lb_grad_xy_2_stencil_update_stream$reg_0_1) : (state->lb_grad_xy_2_stencil_update_stream$reg_0_2));
   (state->lb_grad_xy_2_stencil_update_stream$reg_1_1) = ((true) ? lb_grad_xy_2_stencil_update_stream$mem_1$mem_rdata : (state->lb_grad_xy_2_stencil_update_stream$reg_1_1));
   (state->lb_grad_xy_2_stencil_update_stream$reg_1_2) = ((true) ? (state->lb_grad_xy_2_stencil_update_stream$reg_1_1) : (state->lb_grad_xy_2_stencil_update_stream$reg_1_2));
   (state->lb_grad_xy_2_stencil_update_stream$reg_2_2) = ((true) ? (state->lb_grad_xy_2_stencil_update_stream$reg_2_1) : (state->lb_grad_xy_2_stencil_update_stream$reg_2_2));
   (state->lb_grad_xy_2_stencil_update_stream$reg_2_1) = ((true) ? lb_grad_xy_2_stencil_update_stream$mem_2$mem_rdata : (state->lb_grad_xy_2_stencil_update_stream$reg_2_1));
   (state->lb_grad_xx_2_stencil_update_stream$reg_0_2) = ((true) ? (state->lb_grad_xx_2_stencil_update_stream$reg_0_1) : (state->lb_grad_xx_2_stencil_update_stream$reg_0_2));
   (state->lb_grad_xx_2_stencil_update_stream$reg_1_1) = ((true) ? lb_grad_xx_2_stencil_update_stream$mem_1$mem_rdata : (state->lb_grad_xx_2_stencil_update_stream$reg_1_1));
   (state->lb_grad_xx_2_stencil_update_stream$reg_1_2) = ((true) ? (state->lb_grad_xx_2_stencil_update_stream$reg_1_1) : (state->lb_grad_xx_2_stencil_update_stream$reg_1_2));
   (state->lb_grad_xx_2_stencil_update_stream$reg_2_2) = ((true) ? (state->lb_grad_xx_2_stencil_update_stream$reg_2_1) : (state->lb_grad_xx_2_stencil_update_stream$reg_2_2));
   (state->lb_grad_xx_2_stencil_update_stream$reg_2_1) = ((true) ? lb_grad_xx_2_stencil_update_stream$mem_2$mem_rdata : (state->lb_grad_xx_2_stencil_update_stream$reg_2_1));
   (state->lb_padded_2_stencil_update_stream$reg_0_1) = ((true) ? (state->self_in_0) : (state->lb_padded_2_stencil_update_stream$reg_0_1));
   (state->lb_padded_2_stencil_update_stream$mem_1$mem)[ (state->lb_padded_2_stencil_update_stream$mem_1$waddr$reg0) ] = ((true && /* LOCAL */lb_padded_2_stencil_update_stream_wen_out) ? (state->self_in_0) : (state->lb_padded_2_stencil_update_stream$mem_1$mem)[ (state->lb_padded_2_stencil_update_stream$mem_1$waddr$reg0) ]);
   (state->lb_grad_yy_2_stencil_update_stream$reg_0_1) = ((true) ? /* LOCAL */mul_715_715_716_out : (state->lb_grad_yy_2_stencil_update_stream$reg_0_1));
   (state->lb_grad_yy_2_stencil_update_stream$mem_1$mem)[ (state->lb_grad_yy_2_stencil_update_stream$mem_1$waddr$reg0) ] = ((true && /* LOCAL */lb_grad_yy_2_stencil_update_stream_wen_out) ? /* LOCAL */mul_715_715_716_out : (state->lb_grad_yy_2_stencil_update_stream$mem_1$mem)[ (state->lb_grad_yy_2_stencil_update_stream$mem_1$waddr$reg0) ]);
   (state->lb_grad_xy_2_stencil_update_stream$reg_0_1) = ((true) ? /* LOCAL */mul_691_693_694_out : (state->lb_grad_xy_2_stencil_update_stream$reg_0_1));
   (state->lb_grad_xy_2_stencil_update_stream$mem_1$mem)[ (state->lb_grad_xy_2_stencil_update_stream$mem_1$waddr$reg0) ] = ((true && /* LOCAL */lb_grad_xy_2_stencil_update_stream_wen_out) ? /* LOCAL */mul_691_693_694_out : (state->lb_grad_xy_2_stencil_update_stream$mem_1$mem)[ (state->lb_grad_xy_2_stencil_update_stream$mem_1$waddr$reg0) ]);
   (state->lb_grad_xx_2_stencil_update_stream$reg_0_1) = ((true) ? /* LOCAL */mul_649_649_650_out : (state->lb_grad_xx_2_stencil_update_stream$reg_0_1));
   (state->lb_grad_xx_2_stencil_update_stream$mem_1$mem)[ (state->lb_grad_xx_2_stencil_update_stream$mem_1$waddr$reg0) ] = ((true && /* LOCAL */lb_grad_xx_2_stencil_update_stream_wen_out) ? /* LOCAL */mul_649_649_650_out : (state->lb_grad_xx_2_stencil_update_stream$mem_1$mem)[ (state->lb_grad_xx_2_stencil_update_stream$mem_1$waddr$reg0) ]);
   (state->lb_p3_cim_stencil_update_stream$reg_0_1) = ((true) ? /* LOCAL */sub_746_749_750_out : (state->lb_p3_cim_stencil_update_stream$reg_0_1));
   (state->lb_p3_cim_stencil_update_stream$mem_1$mem)[ (state->lb_p3_cim_stencil_update_stream$mem_1$waddr$reg0) ] = ((true && /* LOCAL */lb_p3_cim_stencil_update_stream_wen_out) ? /* LOCAL */sub_746_749_750_out : (state->lb_p3_cim_stencil_update_stream$mem_1$mem)[ (state->lb_p3_cim_stencil_update_stream$mem_1$waddr$reg0) ]);
