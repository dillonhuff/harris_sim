...
void simulate_0( circuit_state* state ) {
  ...
  //cout << "Print point -3 0" << endl;

  lb_padded_2_stencil_update_stream$mem_2$add_w_out = MASK( 9, (lb_padded_2_stencil_update_stream$mem_2$waddr$reg0_out + lb_padded_2_stencil_update_stream$mem_2$c1_out) );
  lb_padded_2_stencil_update_stream$mem_2$raddr$reg0_out = (state->lb_padded_2_stencil_update_stream$mem_2$raddr$reg0);

  //cout << "Print point -3 1 0" << endl;
  ...
  lb_padded_2_stencil_update_stream$mem_2$add_r_out = MASK( 9, (lb_padded_2_stencil_update_stream$mem_2$raddr$reg0_out + lb_padded_2_stencil_update_stream$mem_2$c1_out) );

  //cout << "Print point -3 1" << endl;
  ...
  lb_padded_2_stencil_update_stream$mem_1$add_w_out = MASK( 9, (lb_padded_2_stencil_update_stream$mem_1$waddr$reg0_out + lb_padded_2_stencil_update_stream$mem_1$c1_out) );
  ...
  lb_padded_2_stencil_update_stream$mem_1$add_r_out = MASK( 9, (lb_padded_2_stencil_update_stream$mem_1$raddr$reg0_out + lb_padded_2_stencil_update_stream$mem_1$c1_out) );
  ...
  lb_p3_cim_stencil_update_stream$mem_2$add_w_out = MASK( 9, (lb_p3_cim_stencil_update_stream$mem_2$waddr$reg0_out + lb_p3_cim_stencil_update_stream$mem_2$c1_out) );
  ...
  lb_p3_cim_stencil_update_stream$mem_2$add_r_out = MASK( 9, (lb_p3_cim_stencil_update_stream$mem_2$raddr$reg0_out + lb_p3_cim_stencil_update_stream$mem_2$c1_out) );
  ...
  lb_p3_cim_stencil_update_stream$mem_1$add_w_out = MASK( 9, (lb_p3_cim_stencil_update_stream$mem_1$waddr$reg0_out + lb_p3_cim_stencil_update_stream$mem_1$c1_out) );
  ...
  lb_p3_cim_stencil_update_stream$mem_1$add_r_out = MASK( 9, (lb_p3_cim_stencil_update_stream$mem_1$raddr$reg0_out + lb_p3_cim_stencil_update_stream$mem_1$c1_out) );
  ...
  lb_grad_yy_2_stencil_update_stream$mem_2$add_w_out = MASK( 9, (lb_grad_yy_2_stencil_update_stream$mem_2$waddr$reg0_out + lb_grad_yy_2_stencil_update_stream$mem_2$c1_out) );
  ...
  lb_grad_yy_2_stencil_update_stream$mem_2$add_r_out = MASK( 9, (lb_grad_yy_2_stencil_update_stream$mem_2$raddr$reg0_out + lb_grad_yy_2_stencil_update_stream$mem_2$c1_out) );
  ...
  lb_grad_yy_2_stencil_update_stream$mem_1$add_w_out = MASK( 9, (lb_grad_yy_2_stencil_update_stream$mem_1$waddr$reg0_out + lb_grad_yy_2_stencil_update_stream$mem_1$c1_out) );
  ...
  lb_grad_yy_2_stencil_update_stream$mem_1$add_r_out = MASK( 9, (lb_grad_yy_2_stencil_update_stream$mem_1$raddr$reg0_out + lb_grad_yy_2_stencil_update_stream$mem_1$c1_out) );
  ...
  lb_grad_xy_2_stencil_update_stream$mem_2$add_w_out = MASK( 9, (lb_grad_xy_2_stencil_update_stream$mem_2$waddr$reg0_out + lb_grad_xy_2_stencil_update_stream$mem_2$c1_out) );
  ...
  lb_grad_xy_2_stencil_update_stream$mem_2$add_r_out = MASK( 9, (lb_grad_xy_2_stencil_update_stream$mem_2$raddr$reg0_out + lb_grad_xy_2_stencil_update_stream$mem_2$c1_out) );
  ...
  lb_grad_xy_2_stencil_update_stream$mem_1$add_w_out = MASK( 9, (lb_grad_xy_2_stencil_update_stream$mem_1$waddr$reg0_out + lb_grad_xy_2_stencil_update_stream$mem_1$c1_out) );
  ...
  lb_grad_xy_2_stencil_update_stream$mem_1$add_r_out = MASK( 9, (lb_grad_xy_2_stencil_update_stream$mem_1$raddr$reg0_out + lb_grad_xy_2_stencil_update_stream$mem_1$c1_out) );
  ...
  lb_grad_xx_2_stencil_update_stream$mem_2$add_w_out = MASK( 9, (lb_grad_xx_2_stencil_update_stream$mem_2$waddr$reg0_out + lb_grad_xx_2_stencil_update_stream$mem_2$c1_out) );
  ...
  lb_grad_xx_2_stencil_update_stream$mem_2$add_r_out = MASK( 9, (lb_grad_xx_2_stencil_update_stream$mem_2$raddr$reg0_out + lb_grad_xx_2_stencil_update_stream$mem_2$c1_out) );
  lb_grad_xx_2_stencil_update_stream$mem_1$zero_const_out = 0b000000000;
  lb_grad_xx_2_stencil_update_stream_wen_out = 1;
  (state->lb_padded_2_stencil_update_stream$reg_2_2) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? lb_padded_2_stencil_update_stream$reg_2_1_out : (state->lb_padded_2_stencil_update_stream$reg_2_2));
  ...
  (state->lb_padded_2_stencil_update_stream$reg_1_2) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? lb_padded_2_stencil_update_stream$reg_1_1_out : (state->lb_padded_2_stencil_update_stream$reg_1_2));
  ...
  (state->lb_padded_2_stencil_update_stream$reg_0_2) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? lb_padded_2_stencil_update_stream$reg_0_1_out : (state->lb_padded_2_stencil_update_stream$reg_0_2));
  (state->lb_padded_2_stencil_update_stream$mem_2$waddr$reg0) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? (lb_padded_2_stencil_update_stream_wen_out ? (MASK( 1, (lb_padded_2_stencil_update_stream$mem_2$add_w_out == lb_padded_2_stencil_update_stream$mem_2$max_const_out) ) ? lb_padded_2_stencil_update_stream$mem_2$zero_const_out : lb_padded_2_stencil_update_stream$mem_2$add_w_out) : lb_padded_2_stencil_update_stream$mem_2$waddr$reg0_out) : (state->lb_padded_2_stencil_update_stream$mem_2$waddr$reg0));
  (state->lb_padded_2_stencil_update_stream$mem_2$raddr$reg0) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? (lb_padded_2_stencil_update_stream_wen_out ? (MASK( 1, (lb_padded_2_stencil_update_stream$mem_2$add_r_out == lb_padded_2_stencil_update_stream$mem_2$max_const_out) ) ? lb_padded_2_stencil_update_stream$mem_2$zero_const_out : lb_padded_2_stencil_update_stream$mem_2$add_r_out) : lb_padded_2_stencil_update_stream$mem_2$raddr$reg0_out) : (state->lb_padded_2_stencil_update_stream$mem_2$raddr$reg0));
  (state->lb_padded_2_stencil_update_stream$mem_2$mem)[ lb_padded_2_stencil_update_stream$mem_2$waddr$reg0_out ] = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1) && lb_padded_2_stencil_update_stream_wen_out) ? lb_padded_2_stencil_update_stream$mem_1$mem_rdata : (state->lb_padded_2_stencil_update_stream$mem_2$mem)[ lb_padded_2_stencil_update_stream$mem_2$waddr$reg0_out ]);
  (state->lb_padded_2_stencil_update_stream$mem_1$waddr$reg0) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? (lb_padded_2_stencil_update_stream_wen_out ? (MASK( 1, (lb_padded_2_stencil_update_stream$mem_1$add_w_out == lb_padded_2_stencil_update_stream$mem_1$max_const_out) ) ? lb_padded_2_stencil_update_stream$mem_1$zero_const_out : lb_padded_2_stencil_update_stream$mem_1$add_w_out) : lb_padded_2_stencil_update_stream$mem_1$waddr$reg0_out) : (state->lb_padded_2_stencil_update_stream$mem_1$waddr$reg0));
  (state->lb_padded_2_stencil_update_stream$mem_1$raddr$reg0) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? (lb_padded_2_stencil_update_stream_wen_out ? (MASK( 1, (lb_padded_2_stencil_update_stream$mem_1$add_r_out == lb_padded_2_stencil_update_stream$mem_1$max_const_out) ) ? lb_padded_2_stencil_update_stream$mem_1$zero_const_out : lb_padded_2_stencil_update_stream$mem_1$add_r_out) : lb_padded_2_stencil_update_stream$mem_1$raddr$reg0_out) : (state->lb_padded_2_stencil_update_stream$mem_1$raddr$reg0));
  (state->lb_p3_cim_stencil_update_stream$reg_2_2) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? lb_p3_cim_stencil_update_stream$reg_2_1_out : (state->lb_p3_cim_stencil_update_stream$reg_2_2));
  ...
  (state->lb_p3_cim_stencil_update_stream$reg_1_2) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? lb_p3_cim_stencil_update_stream$reg_1_1_out : (state->lb_p3_cim_stencil_update_stream$reg_1_2));
  ...
  (state->lb_p3_cim_stencil_update_stream$reg_0_2) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? lb_p3_cim_stencil_update_stream$reg_0_1_out : (state->lb_p3_cim_stencil_update_stream$reg_0_2));
  (state->lb_p3_cim_stencil_update_stream$mem_2$waddr$reg0) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? (lb_p3_cim_stencil_update_stream_wen_out ? (MASK( 1, (lb_p3_cim_stencil_update_stream$mem_2$add_w_out == lb_p3_cim_stencil_update_stream$mem_2$max_const_out) ) ? lb_p3_cim_stencil_update_stream$mem_2$zero_const_out : lb_p3_cim_stencil_update_stream$mem_2$add_w_out) : lb_p3_cim_stencil_update_stream$mem_2$waddr$reg0_out) : (state->lb_p3_cim_stencil_update_stream$mem_2$waddr$reg0));

  //cout << "Print Mid 0" << endl;

  (state->lb_p3_cim_stencil_update_stream$mem_2$raddr$reg0) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? (lb_p3_cim_stencil_update_stream_wen_out ? (MASK( 1, (lb_p3_cim_stencil_update_stream$mem_2$add_r_out == lb_p3_cim_stencil_update_stream$mem_2$max_const_out) ) ? lb_p3_cim_stencil_update_stream$mem_2$zero_const_out : lb_p3_cim_stencil_update_stream$mem_2$add_r_out) : lb_p3_cim_stencil_update_stream$mem_2$raddr$reg0_out) : (state->lb_p3_cim_stencil_update_stream$mem_2$raddr$reg0));
  (state->lb_p3_cim_stencil_update_stream$mem_2$mem)[ lb_p3_cim_stencil_update_stream$mem_2$waddr$reg0_out ] = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1) && lb_p3_cim_stencil_update_stream_wen_out) ? lb_p3_cim_stencil_update_stream$mem_1$mem_rdata : (state->lb_p3_cim_stencil_update_stream$mem_2$mem)[ lb_p3_cim_stencil_update_stream$mem_2$waddr$reg0_out ]);
  (state->lb_p3_cim_stencil_update_stream$mem_1$waddr$reg0) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? (lb_p3_cim_stencil_update_stream_wen_out ? (MASK( 1, (lb_p3_cim_stencil_update_stream$mem_1$add_w_out == lb_p3_cim_stencil_update_stream$mem_1$max_const_out) ) ? lb_p3_cim_stencil_update_stream$mem_1$zero_const_out : lb_p3_cim_stencil_update_stream$mem_1$add_w_out) : lb_p3_cim_stencil_update_stream$mem_1$waddr$reg0_out) : (state->lb_p3_cim_stencil_update_stream$mem_1$waddr$reg0));
  (state->lb_p3_cim_stencil_update_stream$mem_1$raddr$reg0) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? (lb_p3_cim_stencil_update_stream_wen_out ? (MASK( 1, (lb_p3_cim_stencil_update_stream$mem_1$add_r_out == lb_p3_cim_stencil_update_stream$mem_1$max_const_out) ) ? lb_p3_cim_stencil_update_stream$mem_1$zero_const_out : lb_p3_cim_stencil_update_stream$mem_1$add_r_out) : lb_p3_cim_stencil_update_stream$mem_1$raddr$reg0_out) : (state->lb_p3_cim_stencil_update_stream$mem_1$raddr$reg0));
  (state->lb_grad_yy_2_stencil_update_stream$mem_2$waddr$reg0) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? (lb_grad_yy_2_stencil_update_stream_wen_out ? (MASK( 1, (lb_grad_yy_2_stencil_update_stream$mem_2$add_w_out == lb_grad_yy_2_stencil_update_stream$mem_2$max_const_out) ) ? lb_grad_yy_2_stencil_update_stream$mem_2$zero_const_out : lb_grad_yy_2_stencil_update_stream$mem_2$add_w_out) : lb_grad_yy_2_stencil_update_stream$mem_2$waddr$reg0_out) : (state->lb_grad_yy_2_stencil_update_stream$mem_2$waddr$reg0));
  (state->lb_grad_yy_2_stencil_update_stream$mem_2$raddr$reg0) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? (lb_grad_yy_2_stencil_update_stream_wen_out ? (MASK( 1, (lb_grad_yy_2_stencil_update_stream$mem_2$add_r_out == lb_grad_yy_2_stencil_update_stream$mem_2$max_const_out) ) ? lb_grad_yy_2_stencil_update_stream$mem_2$zero_const_out : lb_grad_yy_2_stencil_update_stream$mem_2$add_r_out) : lb_grad_yy_2_stencil_update_stream$mem_2$raddr$reg0_out) : (state->lb_grad_yy_2_stencil_update_stream$mem_2$raddr$reg0));
  (state->lb_grad_yy_2_stencil_update_stream$mem_2$mem)[ lb_grad_yy_2_stencil_update_stream$mem_2$waddr$reg0_out ] = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1) && lb_grad_yy_2_stencil_update_stream_wen_out) ? lb_grad_yy_2_stencil_update_stream$mem_1$mem_rdata : (state->lb_grad_yy_2_stencil_update_stream$mem_2$mem)[ lb_grad_yy_2_stencil_update_stream$mem_2$waddr$reg0_out ]);
  (state->lb_grad_yy_2_stencil_update_stream$mem_1$waddr$reg0) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? (lb_grad_yy_2_stencil_update_stream_wen_out ? (MASK( 1, (lb_grad_yy_2_stencil_update_stream$mem_1$add_w_out == lb_grad_yy_2_stencil_update_stream$mem_1$max_const_out) ) ? lb_grad_yy_2_stencil_update_stream$mem_1$zero_const_out : lb_grad_yy_2_stencil_update_stream$mem_1$add_w_out) : lb_grad_yy_2_stencil_update_stream$mem_1$waddr$reg0_out) : (state->lb_grad_yy_2_stencil_update_stream$mem_1$waddr$reg0));
  (state->lb_grad_yy_2_stencil_update_stream$mem_1$raddr$reg0) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? (lb_grad_yy_2_stencil_update_stream_wen_out ? (MASK( 1, (lb_grad_yy_2_stencil_update_stream$mem_1$add_r_out == lb_grad_yy_2_stencil_update_stream$mem_1$max_const_out) ) ? lb_grad_yy_2_stencil_update_stream$mem_1$zero_const_out : lb_grad_yy_2_stencil_update_stream$mem_1$add_r_out) : lb_grad_yy_2_stencil_update_stream$mem_1$raddr$reg0_out) : (state->lb_grad_yy_2_stencil_update_stream$mem_1$raddr$reg0));
  (state->lb_grad_xy_2_stencil_update_stream$mem_2$waddr$reg0) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? (lb_grad_xy_2_stencil_update_stream_wen_out ? (MASK( 1, (lb_grad_xy_2_stencil_update_stream$mem_2$add_w_out == lb_grad_xy_2_stencil_update_stream$mem_2$max_const_out) ) ? lb_grad_xy_2_stencil_update_stream$mem_2$zero_const_out : lb_grad_xy_2_stencil_update_stream$mem_2$add_w_out) : lb_grad_xy_2_stencil_update_stream$mem_2$waddr$reg0_out) : (state->lb_grad_xy_2_stencil_update_stream$mem_2$waddr$reg0));
  (state->lb_grad_xy_2_stencil_update_stream$mem_2$raddr$reg0) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? (lb_grad_xy_2_stencil_update_stream_wen_out ? (MASK( 1, (lb_grad_xy_2_stencil_update_stream$mem_2$add_r_out == lb_grad_xy_2_stencil_update_stream$mem_2$max_const_out) ) ? lb_grad_xy_2_stencil_update_stream$mem_2$zero_const_out : lb_grad_xy_2_stencil_update_stream$mem_2$add_r_out) : lb_grad_xy_2_stencil_update_stream$mem_2$raddr$reg0_out) : (state->lb_grad_xy_2_stencil_update_stream$mem_2$raddr$reg0));
  (state->lb_grad_xy_2_stencil_update_stream$mem_2$mem)[ lb_grad_xy_2_stencil_update_stream$mem_2$waddr$reg0_out ] = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1) && lb_grad_xy_2_stencil_update_stream_wen_out) ? lb_grad_xy_2_stencil_update_stream$mem_1$mem_rdata : (state->lb_grad_xy_2_stencil_update_stream$mem_2$mem)[ lb_grad_xy_2_stencil_update_stream$mem_2$waddr$reg0_out ]);
  (state->lb_grad_xy_2_stencil_update_stream$mem_1$waddr$reg0) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? (lb_grad_xy_2_stencil_update_stream_wen_out ? (MASK( 1, (lb_grad_xy_2_stencil_update_stream$mem_1$add_w_out == lb_grad_xy_2_stencil_update_stream$mem_1$max_const_out) ) ? lb_grad_xy_2_stencil_update_stream$mem_1$zero_const_out : lb_grad_xy_2_stencil_update_stream$mem_1$add_w_out) : lb_grad_xy_2_stencil_update_stream$mem_1$waddr$reg0_out) : (state->lb_grad_xy_2_stencil_update_stream$mem_1$waddr$reg0));
  (state->lb_grad_xy_2_stencil_update_stream$mem_1$raddr$reg0) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? (lb_grad_xy_2_stencil_update_stream_wen_out ? (MASK( 1, (lb_grad_xy_2_stencil_update_stream$mem_1$add_r_out == lb_grad_xy_2_stencil_update_stream$mem_1$max_const_out) ) ? lb_grad_xy_2_stencil_update_stream$mem_1$zero_const_out : lb_grad_xy_2_stencil_update_stream$mem_1$add_r_out) : lb_grad_xy_2_stencil_update_stream$mem_1$raddr$reg0_out) : (state->lb_grad_xy_2_stencil_update_stream$mem_1$raddr$reg0));
  (state->lb_grad_xx_2_stencil_update_stream$mem_2$waddr$reg0) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? (lb_grad_xx_2_stencil_update_stream_wen_out ? (MASK( 1, (lb_grad_xx_2_stencil_update_stream$mem_2$add_w_out == lb_grad_xx_2_stencil_update_stream$mem_2$max_const_out) ) ? lb_grad_xx_2_stencil_update_stream$mem_2$zero_const_out : lb_grad_xx_2_stencil_update_stream$mem_2$add_w_out) : lb_grad_xx_2_stencil_update_stream$mem_2$waddr$reg0_out) : (state->lb_grad_xx_2_stencil_update_stream$mem_2$waddr$reg0));
  (state->lb_grad_xx_2_stencil_update_stream$mem_2$raddr$reg0) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? (lb_grad_xx_2_stencil_update_stream_wen_out ? (MASK( 1, (lb_grad_xx_2_stencil_update_stream$mem_2$add_r_out == lb_grad_xx_2_stencil_update_stream$mem_2$max_const_out) ) ? lb_grad_xx_2_stencil_update_stream$mem_2$zero_const_out : lb_grad_xx_2_stencil_update_stream$mem_2$add_r_out) : lb_grad_xx_2_stencil_update_stream$mem_2$raddr$reg0_out) : (state->lb_grad_xx_2_stencil_update_stream$mem_2$raddr$reg0));
  ...
  lb_grad_xx_2_stencil_update_stream$mem_1$add_w_out = MASK( 9, (lb_grad_xx_2_stencil_update_stream$mem_1$waddr$reg0_out + lb_grad_xx_2_stencil_update_stream$mem_1$c1_out) );
  (state->lb_grad_xx_2_stencil_update_stream$mem_1$waddr$reg0) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? (lb_grad_xx_2_stencil_update_stream_wen_out ? (MASK( 1, (lb_grad_xx_2_stencil_update_stream$mem_1$add_w_out == lb_grad_xx_2_stencil_update_stream$mem_1$max_const_out) ) ? lb_grad_xx_2_stencil_update_stream$mem_1$zero_const_out : lb_grad_xx_2_stencil_update_stream$mem_1$add_w_out) : lb_grad_xx_2_stencil_update_stream$mem_1$waddr$reg0_out) : (state->lb_grad_xx_2_stencil_update_stream$mem_1$waddr$reg0));
  ...
  (state->lb_grad_xx_2_stencil_update_stream$mem_2$mem)[ lb_grad_xx_2_stencil_update_stream$mem_2$waddr$reg0_out ] = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1) && lb_grad_xx_2_stencil_update_stream_wen_out) ? lb_grad_xx_2_stencil_update_stream$mem_1$mem_rdata : (state->lb_grad_xx_2_stencil_update_stream$mem_2$mem)[ lb_grad_xx_2_stencil_update_stream$mem_2$waddr$reg0_out ]);
  lb_grad_xx_2_stencil_update_stream$mem_1$add_r_out = MASK( 9, (lb_grad_xx_2_stencil_update_stream$mem_1$raddr$reg0_out + lb_grad_xx_2_stencil_update_stream$mem_1$c1_out) );
  (state->lb_grad_xx_2_stencil_update_stream$mem_1$raddr$reg0) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? (lb_grad_xx_2_stencil_update_stream_wen_out ? (MASK( 1, (lb_grad_xx_2_stencil_update_stream$mem_1$add_r_out == lb_grad_xx_2_stencil_update_stream$mem_1$max_const_out) ) ? lb_grad_xx_2_stencil_update_stream$mem_1$zero_const_out : lb_grad_xx_2_stencil_update_stream$mem_1$add_r_out) : lb_grad_xx_2_stencil_update_stream$mem_1$raddr$reg0_out) : (state->lb_grad_xx_2_stencil_update_stream$mem_1$raddr$reg0));
  ...
  (state->lb_grad_yy_2_stencil_update_stream$reg_0_2) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? lb_grad_yy_2_stencil_update_stream$reg_0_1_out : (state->lb_grad_yy_2_stencil_update_stream$reg_0_2));
  ...
  (state->lb_grad_yy_2_stencil_update_stream$reg_1_2) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? lb_grad_yy_2_stencil_update_stream$reg_1_1_out : (state->lb_grad_yy_2_stencil_update_stream$reg_1_2));
  lb_grad_yy_2_stencil_update_stream$reg_2_1_out = (state->lb_grad_yy_2_stencil_update_stream$reg_2_1);
  (state->lb_grad_yy_2_stencil_update_stream$reg_2_2) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? lb_grad_yy_2_stencil_update_stream$reg_2_1_out : (state->lb_grad_yy_2_stencil_update_stream$reg_2_2));
  ...
  (state->lb_grad_xy_2_stencil_update_stream$reg_0_2) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? lb_grad_xy_2_stencil_update_stream$reg_0_1_out : (state->lb_grad_xy_2_stencil_update_stream$reg_0_2));
  ...
  (state->lb_grad_xy_2_stencil_update_stream$reg_1_2) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? lb_grad_xy_2_stencil_update_stream$reg_1_1_out : (state->lb_grad_xy_2_stencil_update_stream$reg_1_2));
  lb_grad_xy_2_stencil_update_stream$reg_2_1_out = (state->lb_grad_xy_2_stencil_update_stream$reg_2_1);
  (state->lb_grad_xy_2_stencil_update_stream$reg_2_2) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? lb_grad_xy_2_stencil_update_stream$reg_2_1_out : (state->lb_grad_xy_2_stencil_update_stream$reg_2_2));
  ...
  (state->lb_grad_xx_2_stencil_update_stream$reg_0_2) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? lb_grad_xx_2_stencil_update_stream$reg_0_1_out : (state->lb_grad_xx_2_stencil_update_stream$reg_0_2));
  ...
  (state->lb_grad_xx_2_stencil_update_stream$reg_1_2) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? lb_grad_xx_2_stencil_update_stream$reg_1_1_out : (state->lb_grad_xx_2_stencil_update_stream$reg_1_2));
  lb_grad_xx_2_stencil_update_stream$reg_2_1_out = (state->lb_grad_xx_2_stencil_update_stream$reg_2_1);
  (state->lb_grad_xx_2_stencil_update_stream$reg_2_2) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? lb_grad_xx_2_stencil_update_stream$reg_2_1_out : (state->lb_grad_xx_2_stencil_update_stream$reg_2_2));
  ...
  (state->lb_padded_2_stencil_update_stream$mem_1$mem)[ lb_padded_2_stencil_update_stream$mem_1$waddr$reg0_out ] = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1) && lb_padded_2_stencil_update_stream_wen_out) ? (state->self_in_0) : (state->lb_padded_2_stencil_update_stream$mem_1$mem)[ lb_padded_2_stencil_update_stream$mem_1$waddr$reg0_out ]);
  ...
  (state->lb_grad_yy_2_stencil_update_stream$reg_0_1) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? mul_715_715_716_out : (state->lb_grad_yy_2_stencil_update_stream$reg_0_1));
  (state->lb_grad_yy_2_stencil_update_stream$mem_1$mem)[ lb_grad_yy_2_stencil_update_stream$mem_1$waddr$reg0_out ] = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1) && lb_grad_yy_2_stencil_update_stream_wen_out) ? mul_715_715_716_out : (state->lb_grad_yy_2_stencil_update_stream$mem_1$mem)[ lb_grad_yy_2_stencil_update_stream$mem_1$waddr$reg0_out ]);
  ...
  (state->lb_grad_xy_2_stencil_update_stream$reg_0_1) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? mul_691_693_694_out : (state->lb_grad_xy_2_stencil_update_stream$reg_0_1));
  (state->lb_grad_xy_2_stencil_update_stream$mem_1$mem)[ lb_grad_xy_2_stencil_update_stream$mem_1$waddr$reg0_out ] = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1) && lb_grad_xy_2_stencil_update_stream_wen_out) ? mul_691_693_694_out : (state->lb_grad_xy_2_stencil_update_stream$mem_1$mem)[ lb_grad_xy_2_stencil_update_stream$mem_1$waddr$reg0_out ]);
  ...
  (state->lb_grad_xx_2_stencil_update_stream$reg_0_1) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? mul_649_649_650_out : (state->lb_grad_xx_2_stencil_update_stream$reg_0_1));
  (state->lb_grad_xx_2_stencil_update_stream$mem_1$mem)[ lb_grad_xx_2_stencil_update_stream$mem_1$waddr$reg0_out ] = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1) && lb_grad_xx_2_stencil_update_stream_wen_out) ? mul_649_649_650_out : (state->lb_grad_xx_2_stencil_update_stream$mem_1$mem)[ lb_grad_xx_2_stencil_update_stream$mem_1$waddr$reg0_out ]);
  ...
  smax_752_753_754$max_mux_out = (MASK( 1, ((int16_t) SIGN_EXTEND( 16, 16, sub_746_749_750_out )) >= ((int16_t) SIGN_EXTEND( 16, 16, lb_p3_cim_stencil_update_stream$reg_2_1_out )) ) ? sub_746_749_750_out : lb_p3_cim_stencil_update_stream$reg_2_1_out);
  smax_754_755_756$max_mux_out = (MASK( 1, ((int16_t) SIGN_EXTEND( 16, 16, smax_752_753_754$max_mux_out )) >= ((int16_t) SIGN_EXTEND( 16, 16, lb_p3_cim_stencil_update_stream$mem_2$mem_rdata )) ) ? smax_752_753_754$max_mux_out : lb_p3_cim_stencil_update_stream$mem_2$mem_rdata);
  smax_756_757_758$max_mux_out = (MASK( 1, ((int16_t) SIGN_EXTEND( 16, 16, smax_754_755_756$max_mux_out )) >= ((int16_t) SIGN_EXTEND( 16, 16, lb_p3_cim_stencil_update_stream$reg_1_2_out )) ) ? smax_754_755_756$max_mux_out : lb_p3_cim_stencil_update_stream$reg_1_2_out);
  smax_758_759_760$max_mux_out = (MASK( 1, ((int16_t) SIGN_EXTEND( 16, 16, smax_756_757_758$max_mux_out )) >= ((int16_t) SIGN_EXTEND( 16, 16, lb_p3_cim_stencil_update_stream$mem_1$mem_rdata )) ) ? smax_756_757_758$max_mux_out : lb_p3_cim_stencil_update_stream$mem_1$mem_rdata);
  smax_760_761_762$max_mux_out = (MASK( 1, ((int16_t) SIGN_EXTEND( 16, 16, smax_758_759_760$max_mux_out )) >= ((int16_t) SIGN_EXTEND( 16, 16, lb_p3_cim_stencil_update_stream$reg_0_2_out )) ) ? smax_758_759_760$max_mux_out : lb_p3_cim_stencil_update_stream$reg_0_2_out);
  smax_762_763_764$max_mux_out = (MASK( 1, ((int16_t) SIGN_EXTEND( 16, 16, smax_760_761_762$max_mux_out )) >= ((int16_t) SIGN_EXTEND( 16, 16, lb_p3_cim_stencil_update_stream$reg_0_1_out )) ) ? smax_760_761_762$max_mux_out : lb_p3_cim_stencil_update_stream$reg_0_1_out);
  (state->self_out) = (MASK( 1, (MASK( 1, ((MASK( 1, ((int16_t) SIGN_EXTEND( 16, 16, smax_762_763_764$max_mux_out )) >= ((int16_t) SIGN_EXTEND( 16, 16, sub_746_749_750_out )) ) ? smax_762_763_764$max_mux_out : sub_746_749_750_out) < lb_p3_cim_stencil_update_stream$reg_1_1_out) ) & MASK( 1, (0b0000000001100100 <= lb_p3_cim_stencil_update_stream$reg_1_1_out) )) ) ? 0b0000000000000000 : 0b0000000011111111);
  (state->lb_p3_cim_stencil_update_stream$reg_0_1) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? sub_746_749_750_out : (state->lb_p3_cim_stencil_update_stream$reg_0_1));
  (state->lb_p3_cim_stencil_update_stream$mem_1$mem)[ lb_p3_cim_stencil_update_stream$mem_1$waddr$reg0_out ] = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1) && lb_p3_cim_stencil_update_stream_wen_out) ? sub_746_749_750_out : (state->lb_p3_cim_stencil_update_stream$mem_1$mem)[ lb_p3_cim_stencil_update_stream$mem_1$waddr$reg0_out ]);
